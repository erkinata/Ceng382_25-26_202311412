//Ai prompt: We will make a task. So we will go step by step i already created an empty project on Visual Code named Projectw7. Keep it on from there. Here is insturctions:
